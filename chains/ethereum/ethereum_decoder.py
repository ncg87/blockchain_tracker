...
class EthereumDecoder:
    ...
    def decode_log(self, log, abi):
        try:
            ...
            event_object = self.sql_query_ops.query_ethereum_event(event_signature)
            ...
            if event_object is None:
                ...
                for event in (e for e in abi if e["type"] == "event"):
                    ...
                    if new_sig.signature_hash == event_signature:
                        ...
                        self.sql_insert_ops.insert_ethereum_event(event_object)
                        break
            if event_object:
            ...
            self.logger.error(f"Error decoding log: {e}", exc_info=True)
            return None
