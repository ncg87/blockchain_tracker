...
CREATE TABLE IF NOT EXISTS base_solana_transactions (
    ...
    account_key CHAR(42) NOT NULL,
    timestamp BIGINT NOT NULL, -- Unix timestamp
    PRIMARY KEY (signature)
);

CREATE INDEX IF NOT EXISTS idx_solana_transactions_block_number ON base_solana_transactions (block_number);
CREATE INDEX IF NOT EXISTS idx_solana_transactions_timestamp ON base_solana_transactions (timestamp);
