...
class BitcoinProcessor(BaseProcessor):
    ...
    async def process_block(self, block):
        ...
        self.db_operator.sql.insert.block.insert_block(self.network, block_number, get_hash(block), get_parent_hash(block), timestamp)
    ...
    def _process_transactions(self, block, block_number, timestamp):
        ...
        try: 
            ...
            self.db_operator.sql.insert.bitcoin.insert_transactions(transactions, block_number)
